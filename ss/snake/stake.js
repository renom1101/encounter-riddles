...
Game = (function(_super) {
  ...
  function Game(h, w, ps) {
    ...
    atom.input.bind(atom.key.SPACE, 'start_game');
    atom.input.bind(atom.key.P, 'toggle_pause');
    this.height = h;
    this.width = w;
    this.pixelsize = ps;
  ...
  Game.prototype.startGame = function() {
    ...
    this.snake = [[_x, _y], [--_x, _y], [--_x, _y], [--_x, _y], [--_x, _y]];
    this.dir = "";
    this.newdir = "right";
    this.score = 0;
    this.gstarted = true;
  ...
  Game.prototype.showIntro = function() {
    ...
    return atom.context.fillText("Press space to start/restart.", 2 * this.pixelsize, this.ty / 2.1);
  };
  ...
  Game.prototype.update = function(dt) {
    ...
    } else if (atom.input.pressed('start_game')) {
        this.eraseCanvas();
        this.startGame();
        this.togglePause();
